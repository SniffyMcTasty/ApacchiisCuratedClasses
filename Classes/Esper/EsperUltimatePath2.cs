...
{
	public class EsperUltimatePath2 : BaseClass
	{
        Player player = Main.player[Main.myPlayer];
        Mod EsperClassMod = ModLoader.GetMod("EsperClass");

        public override string Texture => "ApacchiisCuratedClasses/Classes/Esper/EsperUltimate";

        public override void SetStaticDefaults()
        {
            if (EsperClassMod != null)
            {
                DisplayName.SetDefault("Class: Esper Ultimate [Path 2]");
                Tooltip.SetDefault("+35% Telekinetic Damage\n" +
                                   "+20% Telekinetic Crit Chance\n" +
                                   "+100% Telekinetic Velocity\n" +
		...
		public override void AddRecipes()
		{
            ...
            recipe.AddIngredient(ModContent.GetInstance<EsperLv8Path2>());
        ...
        public override void UpdateAccessory (Player player, bool hideVisual)
		{
            ...
            if (EsperClassMod != null)
            {
                ...
                tkDamage.SetValue(ECPlayer, oldtkDamage + 0.35f);
                ...
                tkCrit.SetValue(ECPlayer, oldtkCrit + 20);
                ...
                tkVel.SetValue(ECPlayer, oldtkVel + 1f);
