...
{
	public class EsperLv7Path2 : BaseClass
	{
        Player player = Main.player[Main.myPlayer];
        Mod EsperClassMod = ModLoader.GetMod("EsperClass");

        public override string Texture => "ApacchiisCuratedClasses/Classes/Esper/EsperLv7";

        public override void SetStaticDefaults()
        {
            if (EsperClassMod != null)
            {
                DisplayName.SetDefault("Class: Esper Lv.7");
                Tooltip.SetDefault("+24.5% Telekinetic Damage\n" +
                                   "+14% Telekinetic Crit Chance\n" +
                                   "+70% Telekinetic Velocity\n" +
		...
		public override void AddRecipes()
		{
            ...
            recipe.AddIngredient(ModContent.GetInstance<EsperLv6Path2>());
